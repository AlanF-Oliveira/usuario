package com.alan.usuario.business.converter;
...
import com.alan.usuario.infrastructure.entity.Endereco;
...
public class UsuarioConverter {
    ...
    public List<Endereco> paraListaEndereco(List<EnderecoDTO> enderecoDTOS){
       List<Endereco> enderecos = new ArrayList<>();
        ...
        return enderecos;
        //return enderecoDTOS.stream().map(this::paraEndereco).toList(); // VERSAO USANDO STREAM
    }
    ...
    public Telefone paraTelefoneEntity(TelefoneDTO telefoneDTO, Long idiUsuario){
        return Telefone.builder()
                .ddd(telefoneDTO.getDdd())
                .numero(telefoneDTO.getNumero())
                .usuario_id(idiUsuario)
                .build();
    }
}
